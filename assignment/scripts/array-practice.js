...
let favoriteFoods = ['olives', 'mint tea', 'rice with broccoli', 'steak', 'quinoa', 'chili'];
...
console.log('Previous last element: ', favoriteFoods.pop());
...
//     log both the food removed and the updated array
console.log('Removed first food: ', favoriteFoods.shift());
